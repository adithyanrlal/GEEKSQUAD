...
const ConsumerLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("producerId", response.data._id);
          ...
          <motion.div className="pt-4 text-center" variants={itemVariants}>
            ...
            <div className="mt-6 pt-2">
              <p className="text-sm text-gray-400 mb-4">
                ...
                <Link to="/producer-signup" className="font-medium text-purple-400 hover:text-purple-300 transition-colors duration-200">
                  Create Account
                </Link>
              </p>
